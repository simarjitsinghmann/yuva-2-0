var instafeedApp = (function instafeedLoad() {
    ...
    var Instafeed = function() {
        ...
        return a.prototype.run = function(a) {
            ...
            return d.open("GET", a || this._buildUrl(), !0),
        ...
        a.prototype.parse = function(a) {
            ...
            if (u = this.options.target,
            u = document.getElementById(u),
            "object" != typeof a)
                throw new Error("Invalid JSON response");
            if (200 !== a.meta.code)
                throw u.innerHTML = this.options.admin ? "<em>" + a.meta.error_message + "</em>" : "",
                new Error("Error from API: " + a.meta.error_message);
            if (0 === a.data.length)
                throw u.innerHTML = "<em>No images were returned from this Instagram account</em>",
                new Error("No images were returned from Instagram");
            ...
            "undefined" != typeof document && null !== document) {
                ...
                isMobileDevice() && validateCharge(this.options.charge) && (w = u.clientWidth / this.options.columnsMobile * window.devicePixelRatio,
                z = parseFloat(100 / this.options.columnsMobile).toFixed(6),
                y = this.options.limitMobile),
                150 >= w ? x = "thumbnail" : 320 >= w && (x = "low_resolution");
                var B = ""
                  , C = "";
                validateCharge(this.options.charge) && 0 < parseInt(this.options.likes) && 4 !== parseInt(this.options.apiVersion) && (B = "<div class='likes'><span style='padding-right: 5px;'><svg width='10' height='10' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z' fill='white'></path></svg></span>{{likes}}<!--<span style='width: 10px;padding-right: 5px;padding-left: 5px;'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512'><path d='M416 192c0-88.4-93.1-160-208-160S0 103.6 0 192c0 34.3 14.1 65.9 38 92-13.4 30.2-35.5 54.2-35.8 54.5-2.2 2.3-2.8 5.7-1.5 8.7S4.8 352 8 352c36.6 0 66.9-12.3 88.7-25 32.2 15.7 70.3 25 111.3 25 114.9 0 208-71.6 208-160zm122 220c23.9-26 38-57.7 38-92 0-66.9-53.5-124.2-129.3-148.1.9 6.6 1.3 13.3 1.3 20.1 0 105.9-107.7 192-240 192-10.8 0-21.3-.8-31.7-1.9C207.8 439.6 281.8 480 368 480c41 0 79.1-9.2 111.3-25 21.8 12.7 52.1 25 88.7 25 3.2 0 6.1-1.9 7.3-4.8 1.3-2.9.7-6.3-1.5-8.7-.3-.3-22.4-24.2-35.8-54.5z' fill='white'></path></svg></span> {{comments}}--></div>",
                C = "<span><span style='padding-right: 5px;'><svg width='10' height='10' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z' fill='grey'></path></svg> {{likes}}</span> <!--<span>&#10078; {{comments}}</span>-->");
                ...
                r = o.length; h < r; h++) {
                    ...
                    l = k.images[x],
                    "object" != typeof l)
                        throw e = "No image found for resolution: " + x + ".",
                        new Error(e);
                    if (k.hasOwnProperty("tagged_products") && 0 < k.tagged_products.length && validateCharge(this.options.charge)) {
                        ...
                        k.tagged_products.forEach(function(a) {
                            H ? (taggedProductUrl = "<object class='product-title'><a href='https://" + I + "/products/" + a.handle + "/' target='_blank' rel='noopener'>" + a.title + "</a><a href='#{{id}}-" + J + "' id='delete-product' data-picture-id='{{fullId}}' data-tagging-id='" + a.id + "'><button class='tagged-buy-button'>Delete</button></a></object>",
                            productImageUrl = "<object><a href='https://" + I + "/products/" + a.handle + "/' target='_blank' rel='noopener'><img class='js-lazy-image' src='https://" + appDomain + "/assets/img/pixel.gif' data-src='" + a.image + "' alt='product image' /></a></object>") : !H && (taggedProductUrl = "<object class='product-title'><a href='//" + window.location.hostname + "/products/" + a.handle + "/'>" + a.title + "</a><a href='//" + window.location.hostname + "/products/" + a.handle + "'><button class='tagged-buy-button'>Shop Now</button></a></object>",
                            productImageUrl = "<object><a href='//" + window.location.hostname + "/products/" + a.handle + "/'><img class='js-lazy-image' src='https://" + appDomain + "/assets/img/pixel.gif' data-src='" + a.image + "' alt='product image' /></a></object>"),
                            G += "<div class='tagged-products' id='{{fullId}}-" + a.id + "'>" + productImageUrl + " " + taggedProductUrl + "</div>"
                        })
                    }
                    var K = "";
                    "video" === k.type && k.hasOwnProperty("videos") ? (K = "instafeed-video",
                    imageFullHtml = "<video controls autoplay playsinline muted id=\"video-{{id}}-instafeed\" preload=\"none\" src=\"" + k.videos.standard_resolution.url + "\"</video>") : imageFullHtml = "<a href='#_'><img class='js-lazy-image' src='//instafeed.nfcube.com/assets/img/pixel.gif' data-src='" + k.images.standard_resolution.url + "' alt='{{captionAlt}}'></a>",
                    n = l.url,
                    ...
                    0 < this.options.slider) {
                        let a = "";
                        1 === this.options.picturesLoaded && (a = "<div style='position:relative;'>"),
                        m = a + "<span class=\"slide-page\" data-slide-page=\"" + O + "\" >" + m + "</span>"
                    }
                    if (g += m,
                    this.options.picturesLoaded >= y || a.data.length === this.options.picturesLoaded) {
                        0 < this.options.slider && a.data.length > N && (g += "<div class=\"slider-arrow\" onclick=\"instafeedSlide(1)\" style=\"right:-15px;\">&#10095;</div>",
                        g += "<div class=\"slider-arrow\" onclick=\"instafeedSlide(-1)\" style=\"left:-15px;\">&#10094;</div>",
                        g += "</div>");
                        break
                    }
                    u.addEventListener("swiped-left", function() {
                        instafeedSlide(1)
                    }),
                    u.addEventListener("swiped-right", function() {
                        instafeedSlide(-1)
                    })
                }
                for (v.innerHTML = g,
                d = [],
                c = 0,
                b = v.childNodes.length; c < b; )
                    d.push(v.childNodes[c]),
                    c += 1;
                for (q = 0,
                s = d.length; q < s; q++)
                    t = d[q],
            ...
            return lazyLoading(),
            0 < this.options.slider && instafeedSlide(0),
            !0
        }
        ,
        a.prototype._buildUrl = function() {
            var a, b;
            if (b = this.options.forceUpdate ? 1 : 0,
            4 === this.options.apiVersion) {
                var c = this.options.limitMobile > this.options.limit ? this.options.limitMobile : this.options.limit;
                a = "https://instafeed.nfcube.com/feed/v4?charge=" + this.options.charge + "&fu=" + b + "&limit=" + c + "&account=" + this.options.shopOrigin + "&fid=" + this.options.feedId + "&hash=" + this.options.hash
            } else if (5 === this.options.apiVersion) {
                var c = this.options.limitMobile > this.options.limit ? this.options.limitMobile : this.options.limit;
                a = "https://instafeed.nfcube.com/feed/v5?charge=" + this.options.charge + "&fu=" + b + "&limit=" + c + "&account=" + this.options.shopOrigin + "&fid=" + this.options.feedId + "&hash=" + this.options.hash
            }
            return a
        }
        ,
        a.prototype._makeTemplate = function(a, b) {
            ...
            c = a; d.test(c); )
                f = c.match(d)[1],
                g = null === (e = this._getObjectProperty(b, f)) ? "" : e,
    ...
    function escapeHtml(a) {
        return a && (a = a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;")),
        a
    }
    function shortenLargeNumber(a, b) {
        for (var c, d = ["k", "M", "G", "T", "P", "E", "Z", "Y"], e = d.length - 1; 0 <= e; e--)
            if (c = Math.pow(1e3, e + 1),
            a <= -c || a >= c)
    ...
    function lazyLoading() {
        ...
        if (!("IntersectionObserver"in window))
            ...
            for (let a, b = 0; b < e.length; b++)
                (a = e[b],
                !a.classList.contains("js-lazy-image--handled")) && f.observe(a)
        }
    }
    (function(a, b) {
        return "function" == typeof define && define.amd ? define([], b) : "object" == typeof module && module.exports ? (module.exports = b(),
        module.exports) : (a.Instafeed = b(),
        a.Instafeed)
    }
    )(this, function() {
        return Instafeed
    ...
    function() {
        if (null !== document.currentScript && !document.currentScript.src.includes(appDomain))
            return !1;
        var a = document.createElement("link");
        a.href = "https://instafeed.nfcube.com/cdn/instafeed-" + cssVer + ".css",
        a.type = "text/css",
        a.rel = "stylesheet",
        a.media = "screen,print",
        document.getElementsByTagName("head")[0].appendChild(a)
    }(),
    function() {
        function a() {
            var a = location.hash.split("!").pop().replace("/", "");
            if (b = document.getElementById("video-" + c.substring(c.lastIndexOf("#") + 1, c.lastIndexOf("-insta-feed")) + "-instafeed"),
            b && (b.pause(),
            b.onplay = function() {
                "#_" === a && b.pause()
            }
            ...
            "#_" === a || 0 === a.length)
                ...
                e && (!0 === d && (e.style.webkitTransform = "translate3d(0, 0, 0)"),
                e.style.overflowY = "visible");
            else if (a.includes("-feed")) {
                if (e) {
                    const a = getComputedStyle(e);
                    "none" !== a.webkitTransform && (e.style.webkitTransform = "initial",
                    d = !0,
                    document.getElementById("insta-feed").scrollIntoView()),
                    e.style.overflowY = "hidden"
                }
                document.body.style.overflowY = "hidden"
            }
        }
        var b, c = "", d = !1, e = document.getElementById("PageContainer");
        window.instafeedSlidePage = 1,
        window.instafeedSlide = function(a=0) {
            instafeedSlidePage = parseInt(instafeedSlidePage) + parseInt(a);
            let b = document.body.querySelectorAll("#insta-feed");
            0 === parseInt(b.length) && (b = document.body.querySelectorAll(".instafeed-shopify")),
            ...
            0 >= instafeedSlidePage && (instafeedSlidePage = d),
            instafeedSlidePage > d && (instafeedSlidePage = 1);
        ...
        !function(b, c) {
            ...
            "function" != typeof b.CustomEvent && (b.CustomEvent = function(b, d) {
                ...
                return e.initCustomEvent(b, d.bubbles, d.cancelable, d.detail),
                e
            }
            ,
            b.CustomEvent.prototype = b.Event.prototype),
            c.addEventListener("touchstart", function(a) {
                "true" === a.target.getAttribute("data-swipe-ignore") || (m = a.target,
                l = Date.now(),
            ...
            c.addEventListener("touchend", function(a) {
                if (m === a.target) {
                    ...
                    if (Math.abs(j) > Math.abs(k) ? Math.abs(j) > i && n < e && (c = 0 < j ? "swiped-left" : "swiped-right") : Math.abs(k) > i && n < e && (c = 0 < k ? "swiped-up" : "swiped-down"),
                    "" != c) {
                        var p = {
    ...
    if (document.getElementById('insta-feed') !== null) {
        var feed = new Instafeed({
            account: '',
            hash: '5c6c429323258313c666d8abd7db81c0',
            apiVersion: 4,
            shopOrigin: 'yuva-theme-2-0.myshopify.com',
            title: 'Testt',
            openIg: 3,
            space: 0,
            likes: 1,
